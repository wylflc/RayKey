...
def main():
    ...
    bt.ACTIONS=ROOT/manifest['current_reference_inputs']['data/raw/corporate_actions/a_share_corporate_actions.csv']
    ...
    for stage in ('all',):
        rows=read(EXP/'signal_observations.csv');summaries=read(EXP/'signal_summary.csv')
        for s in summaries:
