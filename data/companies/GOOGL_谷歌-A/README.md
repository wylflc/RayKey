...
证据 2026-07-22（二季报（2026Q2））。方法：ROIC·增长（§6.5.2.3 同口径）；带 246.97~301.86 USD。

ROIC·增长（§6.5.2.3 同口径，财年 2021~2025＋截至 2026-06-30 TTM，SEC companyfacts 10-Q TTM）：NOPAT/母公司权益财年序列 0.303／0.235／0.261／0.309／0.320 → ratio0 **0.303**（cyclical_median）× 当期 BPS 52.03（母公司权益 ÷ 稀释股数 12,309m）= 每股 NOPAT 锚 **15.782**；周期守卫 NOPAT/母公司权益：当期 0.592（最新年报 0.320 × f 1.85）vs 十年中位 0.208 = 2.84×，坡道 w=1.00／谷 v=0.00；信任度 λ=1.0，非周期锚 = 三年中位 0.309 + λ×(当期 − 三年中位) = 0.592，五年中位 0.303，ratio0 = (1−max(w,v))×非周期锚 + max(w,v)×五年中位；最新观察点回购 17.4b；ROIC0 44.6%；WACC 7.83%（r 8.80% = rf 4.79% + β0.9×ERP 4.46%；rd 2.00%；t 18%；账面权重）；增长 g0=10.5%（来源 capital：资本腿 10.5%=min(增量ROIC 26.6%,40%)×再投资率 40%，增速腿 —），ROIC_T=min(WACC+档位超额, ROIC0)=13.8%，g_T=3.0%，fade 10 年，终值占比 79%；净负债/股 -10.837（有息负债−超额现金＋少数股东扣减，扣减取账面与账面份额×权益价值较大者）；**V = 274.416 USD/普通股** → **274.42 USD**；带 = V×[0.90,1.10]。标签：buybacks=PaymentsForRepurchaseOfCommonStock;capex=PaymentsToAcquirePropertyPlantAndEquipment;cash=CashAndCashEquivalentsAtCarryingValue;cash_invest=MarketableSecuritiesCurrent;cfo=NetCashProvidedByUsedInOperatingActivities;dep_amort=Depreciation;dividends_paid=PaymentsOfOrdinaryDividends;income_tax=IncomeTaxExpenseBenefit;interest_expense=InterestExpenseNonoperating;lt_debt_current=LongTermDebtCur
