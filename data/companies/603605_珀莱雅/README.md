...
新入池建档（2026-08-10）。PE-TTM 15.5。**判定基于 2025年报+2026Q1，待 2026 中报确认**

## 二、带的推导（须可复算）

2026E 归母一致预期中位 16.09亿（ycmx 16 家研报中位数，§6.6 口径）× 14.29x（终值 PE 1/(10%−3%)）× L2 分层系数 [0.85, 1.05] ÷ 总股本 3.96亿股 = 49.35~60.96 元。2025A 实际归母 14.98亿。多品牌验证，线上运营为核心资产
