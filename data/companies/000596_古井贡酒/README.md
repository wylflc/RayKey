...
新入池建档（2026-08-10）。PE-TTM 17.15。**判定基于 2025年报+2026Q1，待 2026 中报确认**

## 二、带的推导（须可复算）

2026E 归母一致预期中位 36.11亿（ycmx 15 家研报中位数，§6.6 口径）× 14.29x（终值 PE 1/(10%−3%)）× L2 分层系数 [0.85, 1.05] ÷ 总股本 5.29亿股 = 82.98~102.50 元。2025A 实际归母 35.49亿。年份原浆价格带卡位
