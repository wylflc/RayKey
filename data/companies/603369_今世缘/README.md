...
新入池建档（2026-08-10）。PE-TTM 14.5。**判定基于 2025年报+2026Q1，待 2026 中报确认**

## 二、带的推导（须可复算）

2026E 归母一致预期中位 26.23亿（ycmx 16 家研报中位数，§6.6 口径）× 14.29x（终值 PE 1/(10%−3%)）× L2 分层系数 [0.85, 1.05] ÷ 总股本 12.47亿股 = 25.55~31.56 元。2025A 实际归母 26.04亿。国缘V系列次高端卡位，省内渠道深度
