...
新入池建档（2026-08-10）。PE-TTM 27.9、PE 分位 17.4%。

## 二、带的推导（须可复算）

2026E 归母一致预期中位 7.62亿（ycmx 16 家研报中位数，§6.6 口径） × 14.29x（终值 PE 1/(10%−3%)）× L2 分层系数 [0.85, 1.05] ÷ 总股本 10.42亿股 = 8.88~10.97 元。2025A 实际归母 6.37亿。RIO 品类份额约八成，需求随即饮酒渗透率
