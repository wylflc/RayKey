...
更新 2026-08-23（`scripts/build_overseas_roic_bands.py`）。方法：ROIC·增长（§6.5.2.3 同口径）；带 38.39~46.92 USD；审定档 高估。

ROIC·增长（§6.5.2.3 同口径，财年 2022~2026，SEC companyfacts us-gaap）：NOPAT/母公司权益 比率 0.698（cyclical_median，周期守卫命中）× BPS 6.42 = NOPAT/股 4.477；ROIC0 115.8%；WACC 8.38%（r 8.75% = rf 4.74% + β0.9×ERP 4.46%；rd 2.59%；t 15%；账面权重）；增长 g0=0.8%（来源 capital：资本腿 0.8%=min(增量ROIC 76.8%,40%)×再投资率 2%，增速腿 —），ROIC_T=min(WACC+档位超额, ROIC0)=14.4%，g_T=3.0%，fade 10 年，终值占比 57%；净负债/股 0.130（有息负债−超额现金＋少数股东权益）；**V = 42.654 USD/普通股** → **42.65 USD**；带 = V×[0.90,1.10]。标签：capex=PaymentsToAcquirePropertyPlantAndEquipment+PaymentsToAcquireProductiveAssets;cash=CashAndCashEquivalentsAtCarryingValue+CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents;cash_invest=MarketableSecuritiesCurrent;cfo=NetCashProvidedByUsedInOperatingActivities;dep_amort=DepreciationDepletionAndAmortization+DepreciationAndAmortization+Depreciation;income_tax=IncomeTaxExpenseBenefit;in
