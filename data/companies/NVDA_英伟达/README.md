...
证据 2026-05-20（一季报（FY2027Q1））。方法：ROIC·增长（§6.5.2.3 同口径）；带 25.52~31.19 USD。

ROIC·增长（§6.5.2.3 同口径，财年 2022~2026＋截至 2026-04-26 TTM，SEC companyfacts 10-Q TTM）：每股 NOPAT 锚（v4.47 OI-082：各年 NOPAT ÷ 最新稀释股数 24,391m）序列 0.41／0.18／1.23／3.00／4.93／6.55 → 取 **2.997**（cyclical_median）；周期守卫 NOPAT/(权益＋累计回购 96.6b)：最新 0.547 vs 10 年中位 0.335（命中→取 5 年中位）；最新观察点回购 45.3b；BPS 8.01；ROIC0 115.8%；WACC 8.45%（r 8.75% = rf 4.74% + β0.9×ERP 4.46%；rd 2.59%；t 16%；账面权重）；增长 g0=0.8%（来源 capital：资本腿 0.8%=min(增量ROIC 76.8%,40%)×再投资率 2%，增速腿 —），ROIC_T=min(WACC+档位超额, ROIC0)=14.5%，g_T=3.0%，fade 10 年，终值占比 56%；净负债/股 0.053（有息负债−超额现金＋少数股东扣减，扣减取账面与账面份额×权益价值较大者）；**V = 28.351 USD/普通股** → **28.35 USD**；带 = V×[0.90,1.10]。标签：buybacks=PaymentsForRepurchaseOfCommonStock;capex=PaymentsToAcquireProductiveAssets;cash=CashAndCashEquivalentsAtCarryingValue;cash_invest=MarketableSecuritiesCurrent;cfo=NetCashProvidedByUsedInOperatingActivities;dep_amort=DepreciationDepletionAndAmortization;dividends_paid=PaymentsOfDividends;income_tax=IncomeTaxExpenseBenefit;interest_expense=InterestExpenseNonoperating;lt_debt_current=LongTerm
