...
更新 2026-08-23（`scripts/build_overseas_roic_bands.py`）。方法：ROIC·增长（§6.5.2.3 同口径）；带 88.53~108.20 USD；审定档 高估。

ROIC·增长（§6.5.2.3 同口径，财年 2022~2026，SEC companyfacts us-gaap）：每股 NOPAT 锚（v4.47 OI-082：各年 NOPAT ÷ 最新稀释股数 24,514m）序列 0.41／0.18／1.22／2.98／4.91 → 取 **4.907**（ttm_growth）；周期守卫 NOPAT/(权益＋累计回购 96.6b)：最新 0.474 vs 10 年中位 0.325（未命中）；最新年回购 40.1b；BPS 6.42；ROIC0 115.8%；WACC 8.38%（r 8.75% = rf 4.74% + β0.9×ERP 4.46%；rd 2.59%；t 15%；账面权重）；增长 g0=25.0%（来源 trailing：资本腿 0.8%=min(增量ROIC 76.8%,40%)×再投资率 2%，增速腿 137.5%），ROIC_T=min(WACC+档位超额, ROIC0)=14.4%，g_T=3.0%，fade 10 年，终值占比 72%；净负债/股 0.130（有息负债−超额现金＋少数股东权益）；**V = 98.362 USD/普通股** → **98.36 USD**；带 = V×[0.90,1.10]。标签：buybacks=PaymentsForRepurchaseOfCommonStock;capex=PaymentsToAcquirePropertyPlantAndEquipment+PaymentsToAcquireProductiveAssets;cash=CashAndCashEquivalentsAtCarryingValue+CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents;cash_invest=MarketableSecuritiesCurrent;cfo=NetCashProvidedByUsedInOperatingActivities;dep_amort=DepreciationDepletionAndAmortization+DepreciationAndAmortization+Deprec
