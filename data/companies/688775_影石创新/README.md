...
新入池建档（2026-08-10）。PE-TTM 64.64。**判定基于 2025年报+2026Q1，待 2026 中报确认**

## 二、带的推导（须可复算）

2026E 归母一致预期中位 11.71亿（ycmx 9 家研报中位数，§6.6 口径）× 14.29x（终值 PE 1/(10%−3%)；不给品类高增速溢价）× L2 分层系数 [0.85, 1.05] ÷ 总股本 4.01亿股 = 35.47~43.82 元。2025A 实际归母 9.29亿。PE-TTM 64.6 为全池最贵档之一
