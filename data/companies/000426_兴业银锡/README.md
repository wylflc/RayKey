...
| 合理价区间 | **23.67 ~ 29.24** |
| 估值方法 | F 资源NAV型：前瞻一致预期 × 13x × 分层系数 |
| 盈利锚 | 38.04 亿元 |
| 本档更新日 | **2026-08-10**｜定案：模型推导，用户可覆盖 |

## 一、为什么脱离通用模型

新入池建档（2026-08-10）。PE-TTM 26.28、PE 分位 29.3%。**周期性风险**：金银价处历史高位，2026E 一致预期隐含当前价格水平；§6.3 第5条要求周期股用中枢而非顶部单年，本带采信前瞻锚是与洛阳钼业（产量结构性抬升）一致的处理，但若商品价格回落，锚需下修。

## 二、带的推导（须可复算）

2026E 归母一致预期中位 38.04亿（ycmx 6 家研报中位数，§6.6 口径） × 13x（资源股不给成长溢价，与洛阳钼业/盐湖股份同档 13x）× L2 分层系数 [0.85, 1.05] ÷ 总股本 17.76亿股 = 23.67~29.24 元。2025A 实际归母 17.04亿。银漫矿业单一矿山依赖度高，故取 13x 下沿而非 14.29 终值 PE
