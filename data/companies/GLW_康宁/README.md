...
证据 2026-07-28（二季报（2026Q2））。方法：ROIC·增长（§6.5.2.3 同口径）；带 19.30~23.59 USD。

ROIC·增长（§6.5.2.3 同口径，财年 2021~2025＋截至 2026-06-30 TTM，Corning official Q2 2026 release TTM plus latest filed Q1 balance）：NOPAT/母公司权益财年序列 0.174／0.134／0.079／0.078／0.172 → ratio0 **0.134**（cyclical_median）× 当期 BPS 13.56（母公司权益 ÷ 稀释股数 871m）= 每股 NOPAT 锚 **1.820**；周期守卫 NOPAT/母公司权益：当期 0.174（最新年报 0.172 × f 1.01）vs 十年中位 0.088 = 1.99×，坡道 w=1.00／谷 v=0.00；信任度 λ=0.5，非周期锚 = 三年中位 0.079 + λ×(当期 − 三年中位) = 0.126，五年中位 0.134，ratio0 = (1−max(w,v))×非周期锚 + max(w,v)×五年中位；最新观察点回购 0.0b；ROIC0 9.1%；WACC 6.80%（r 9.25% = rf 4.79% + β1.0×ERP 4.46%；rd 4.33%；t 21%；账面权重）；增长 g0=0.0%（来源 none：资本腿 —=min(增量ROIC -6.5%,40%)×再投资率 -94%，增速腿 —），ROIC_T=min(WACC+档位超额, ROIC0)=9.1%，g_T=3.0%，fade 10 年，终值占比 65%；净负债/股 9.651（有息负债−超额现金＋少数股东扣减，扣减取账面与账面份额×权益价值较大者）；**V = 21.445 USD/普通股** → **21.44 USD**；带 = V×[0.90,1.10]。标签：
