...
证据 2026-07-28（二季报（2026Q2））。方法：ROIC·增长（§6.5.2.3 同口径）；带 18.90~23.10 USD。

ROIC·增长（§6.5.2.3 同口径，财年 2021~2025＋截至 2026-06-30 TTM，Corning official Q2 2026 release TTM plus latest filed Q1 balance）：NOPAT/经营账面财年序列 0.114／0.087／0.050／0.048／0.111 → ratio0 **0.085**（blend(λ=0.5,w=0.69,v=0.00)）× 经营账面 BPS_op 20.99（稀释股数 871m）= 每股 NOPAT 锚 **1.792**；股本口径：十年窗 |X_y|≥5% 年份 FY2017 -1.9b／FY2018 -2.1b／FY2019 -0.9b／FY2021 -1.5b；年报已计累计外生权益 -6.5b（最新年报经营账面 E_op 18.3b，母公司权益 11.8b）；年报后 x +0.00/股（np_gap）；BPS_op = 当期 BPS 13.56 − x − X_cum/股 -7.42 = 20.99；周期守卫 NOPAT/经营账面：当期 0.112（最新年报 0.111 × f 1.01）vs 十年中位 0.066 = 1.71×，坡道 w=0.69／谷 v=0.00；信任度 λ=0.5，非周期锚 = 三年中位 0.050 + λ×(当期 − 三年中位) = 0.081，五年中位 0.087，ratio0 = (1−max(w,v))×非周期锚 + max(w,v)×五年中位；最新观察点回购 0.0b；ROIC0 9.1%；WACC 6.80%（r 9.25% = rf 4.79% + β1.0×ERP 4.46%；rd 4.33%；t 21%；账面权重）；增长 g0=0.0%（来源 none：资本腿 —=min(增量ROIC -6.5%,40%)×再投资率 -94%，增速腿 —），ROIC_T=min(WACC+档位超额, ROIC0)=9.1%，g_T=3.0%，fade 10 年，终值占比 65%；净负债/股 9.631（有息负债−超额现金＋少数股东扣减，扣减取账面与账面份额×权益价值较大者）；**V = 20.998 USD/普通股** → **21.00 USD**；带 = V×[0.90,1.10]。标签：
