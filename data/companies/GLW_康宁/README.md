...
证据 2026-07-28（二季报（2026Q2））。方法：ROIC·增长（§6.5.2.3 同口径）；带 22.02~26.91 USD。

ROIC·增长（§6.5.2.3 同口径，财年 2021~2025＋截至 2026-06-30 TTM，Corning official Q2 2026 release TTM plus latest filed Q1 balance）：每股 NOPAT 锚（v4.47 OI-082：各年 NOPAT ÷ 最新稀释股数 871m）序列 2.46／1.85／1.04／0.95／2.33／2.36 → 取 **2.004**（blend(λ=1.0,w=0.69,v=0.00)）；周期守卫 NOPAT/(权益＋累计回购 10.8b)：最新 0.091 vs 10 年中位 0.053 = 1.72×，坡道 w=0.69／谷 v=0.00；信任度 λ=1.0，非周期锚 = 三年中位 2.327 + λ×(当期 − 三年中位) = 2.357，五年中位 1.850，锚 = (1−max(w,v))×非周期锚 + max(w,v)×五年中位；最新观察点回购 0.0b；BPS 13.56；ROIC0 9.1%；WACC 6.80%（r 9.25% = rf 4.79% + β1.0×ERP 4.46%；rd 4.33%；t 21%；账面权重）；增长 g0=0.0%（来源 none：资本腿 —=min(增量ROIC -6.5%,40%)×再投资率 -94%，增速腿 —），ROIC_T=min(WACC+档位超额, ROIC0)=9.1%，g_T=3.0%，fade 10 年，终值占比 65%；净负债/股 9.789（有息负债−超额现金＋少数股东扣减，扣减取账面与账面份额×权益价值较大者）；**V = 24.466 USD/普通股** → **24.47 USD**；带 = V×[0.90,1.10]。标签：
