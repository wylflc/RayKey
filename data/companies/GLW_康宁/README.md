...
更新 2026-08-23（`scripts/build_overseas_roic_bands.py`）。方法：ROIC·增长（§6.5.2.3 同口径）；带 19.41~23.73 USD；审定档 高估。

ROIC·增长（§6.5.2.3 同口径，财年 2021~2025，SEC companyfacts us-gaap）：每股 NOPAT 锚（v4.47 OI-082：各年 NOPAT ÷ 最新稀释股数 871m）序列 2.46／1.85／1.04／0.95／2.33 → 取 **1.850**（cyclical_median）；周期守卫 NOPAT/(权益＋累计回购 10.8b)：最新 0.090 vs 10 年中位 0.051（命中→取 5 年中位）；最新年回购 0.2b；BPS 13.56；ROIC0 9.1%；WACC 6.95%（r 9.20% = rf 4.74% + β1.0×ERP 4.46%；rd 4.33%；t 15%；账面权重）；增长 g0=0.0%（来源 none：资本腿 —=min(增量ROIC -6.5%,40%)×再投资率 -94%，增速腿 —），ROIC_T=min(WACC+档位超额, ROIC0)=9.1%，g_T=3.0%，fade 10 年，终值占比 64%；净负债/股 8.864（有息负债−超额现金＋少数股东权益）；**V = 21.571 USD/普通股** → **21.57 USD**；带 = V×[0.90,1.10]。标签：buybacks=PaymentsForRepurchaseOfCommonStock;capex=PaymentsToAcquireProductiveAssets;cash=CashAndCashEquivalentsAtCarryingValue+CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents;cfo=NetCashProvidedByUsedInOperatingActivities+NetCashProvidedByUsedInOperatingActivitiesContinuingOperations;dep_amort=Depreciation;dividends_paid=PaymentsOfDividendsCommonStock+PaymentsOfOrdinaryDividends;inco
