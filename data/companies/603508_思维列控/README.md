...
新入池建档（2026-08-10）。PE-TTM 15.23、PE 分位 20.1%。

## 二、带的推导（须可复算）

2026E 归母一致预期中位 6.88亿（ycmx 3 家研报中位数，§6.6 口径） × 14.29x（终值 PE 1/(10%−3%)）× L2 分层系数 [0.85, 1.05] ÷ 总股本 3.81亿股 = 21.92~27.08 元。2025A 实际归母 5.56亿。**一致预期仅 3 家覆盖，为 §6.6 可用下限**；LKJ 强制安装，毛利率九年由 58.5% 升至 66.5%
