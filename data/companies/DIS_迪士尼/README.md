...
证据 2026-08-05（三季报（FY2026Q3））。方法：ROIC·零增长（§6.5.2.3 同口径）；带 28.42~34.74 USD。

ROIC·零增长（§6.5.2.3 同口径，财年 2021~2025＋截至 2026-06-27 TTM，SEC companyfacts 10-Q TTM）：每股 NOPAT 锚（v4.47 OI-082：各年 NOPAT ÷ 最新稀释股数 1,743m）序列 2.33／2.64／1.14／2.41／5.85／4.54 → 取 **4.539**（median3）；周期守卫 NOPAT/(权益＋累计回购 19.4b)：最新 0.061 vs 10 年中位 0.043（未命中）；最新观察点回购 8.2b；BPS 63.13；ROIC0 3.1%；WACC 7.56%（r 9.25% = rf 4.79% + β1.0×ERP 4.46%；rd 4.50%；t 28%；账面权重）；零增长：V = NOPAT/股 ÷ WACC − 净负债/股；净负债/股 28.481（有息负债−超额现金＋少数股东扣减，扣减取账面与账面份额×权益价值较大者）；**V = 31.581 USD/普通股** → **31.58 USD**；带 = V×[0.90,1.10]。标签：buybacks=PaymentsForRepurchaseOfCommonStock;capex=PaymentsToAcquirePropertyPlantAndEquipment;cash=CashAndCashEquivalentsAtCarryingValue;cash_invest=;cfo=NetCashProvidedByUsedInOperatingActivities;dep_amort=DepreciationDepletionAndAmortization;dividends_paid=PaymentsOfDividendsCommonStock;income_tax=IncomeTaxExpenseBenefit;interest_expense=InterestExpense;lt_debt_current=LongTermDebtCurrent;lt_debt
