...
| 版本 | 日期 | 内容 |
| --- | --- | --- |
| v4.174 | 2026-09-10 | 轨道 A 记账修复：日末盯市对当日新建仓取成交日收盘（OI-169）；买入委托含费税须在现金＋剩余授信内、最终委托按手缩量、同日对冲退回卖出款先在授信内融回（OI-170）；summary 与扫描文件增 `最低现金`／`最低现金日`／`负现金日数`，跨起点尾部同报。落点：§12.1 第 2 款「资金记账」、`backtest_valuation_strategy`（affordable_amount／affordable_shares／net_off_sale）、`sweep_backtest_configs.FIELDS`。BASE 与在评候选按 m3 同批重算见 §12.223 |
