...
| `backtest_candidate_strategies.md` | 2026-08-08 登记的「多起点检验后成立、待用户裁定」的回测配置 | **v2.97 归档**：其中的候选此后已全部裁定完毕（相关性 0.85、一档 1.0%、换仓 0.15、建仓日 MA20 止损均已进 §9.7.1；止损「无」那一条已被 §12.20.3 翻转），而它的全部年化数字产生于「今日 261 池」，早于时点面板、λ=2.0、银行股利折现与 V3/V4 三次换宇宙。留在 `docs/` 主目录会被误读为「尚有待裁定的候选」。现行基准只在 §9.7.1.2 |
