...
| `C070` | 风险约束 | `--max-corr 0.70` | 恢复簇约束（v4.131 前在册；反向臂 `C100` 上一纪元 +6.40／+0.27） | 未测 |
| `G125G` | 操作规则 | `--gain-sell 1.25 --gain-sell-mode gated` | 恢复走势闸门与 125% 阈值（v4.131 前在册；反向臂 `G110U` 上一纪元 +9.15／+3.68） | 未测 |
