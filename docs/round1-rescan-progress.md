...
- **Standard:** `docs/000_Ashare_workflow.md` §5.4 — 5.4.1 总体原则 / 5.4.2 三类定义 / 5.4.3 garbage 条件 / 5.4.4 输出字段 / 5.4.5 行业校准锚（规则 1-11 + 防过度纳入清单）/ 5.4.6 执行流程; and `docs/adr/0006-round-1-three-class-triage-standard.md`.
...
| --- | ---: |
| worth_attention | 77 |
| boundary_pending | 251 |
| garbage | 16 (governance_fraud 2 / structural_industry 14) |
| **Total triaged** | **344 / 5653** |

Remaining: `1_worth_attention` (prior worth_attention) **933** · `2_ex_l5_boundary` **421** · `3_unreviewed` **3955**.

Batches done: 3 industry-calibration batches (baijiu 21, panel 8, decoration 15) + 12 priority-1 batches (300). Cadence 25/batch.

### Current worth_attention pool (77)

- **品牌消费:** 贵州茅台·五粮液·山西汾酒·泸州老窖·洋河股份(白酒) · 东阿阿胶·云南白药·华润三九(中药/OTC) · 美的集团·格力电器·苏泊尔(家电/炊具) · 双汇发展(肉制品)
- **垄断/稀缺资源:** 藏格矿业·盐湖股份(盐湖钾锂) · 锡业股份(全球锡) · 赣锋锂业·天齐锂业·中矿资源(全球锂资源/锂盐/小金属)
- **军工高壁垒电子:** 振华科技·航天电器·中航光电(器件/连接器) · 紫光国微(军工FPGA) · 海格通信(军工通信/北斗)
- **AI/半导体/高端电子:** 沃尔核材(高速铜连接) · 顺络电子(高端电感) · 通富微电(先进封装) · 福晶科技(光学晶体) · 光迅科技(光器件/光芯片) · 北方华创(半导体设备) · 东山精密(AI PCB/FPC/光模块制造) · 沪电股份·深南电路·鹏鼎控股(AI高速PCB/封装基板) · 雅克科技(半导体材料/前驱体) · 中瓷电子(电子陶瓷/高端封装材料) · 江海股份(高端电容器) · 高德红外(红外/特种光电)
- **软件/硬件生态:** 大华股份·海康威视(安防AIoT) · 石基信息(酒店信息系统) · 奔图科技(国产打印生态)
- **科技/装备龙头:** 中兴通讯·紫光股份(新华三) · 大族激光 · 三花智控(全球热管理) · 汉钟精机(压缩机/真空泵) · 华明装备(分接开关) · 水晶光电(精密光学) · 英维克(AIDC液冷/温控) · 奥普光电(军工光电) · 杭氧股份(空分设备/工业气体) · 江苏神通(核电/特种阀门) · 豪迈科技(轮胎模具/大型零部件)
- **资本周期龙头(规则6):** 京东方A·TCL科技(面板) · 中联重科·徐工机械·潍柴动力·中国重汽(机械/重卡)
- **金融:** 宁波银行
- **医药/生物:** 长春高新(金赛) · 华兰生物(浆站) · 上海莱士(血液制品) · 恩华药业(CNS/麻醉精神药) · 科伦药业(输液/ADC创新药) · 东诚药业(核药) · 凯莱英(CDMO) · 鱼跃医疗(家用医疗器械) · 隆平高科(种业/转基因)
- **农牧服务:** 海大集团(饲料/养殖服务平台)
- **化工寡头:** 新和成(维生素)
- **平台网络:** 分众传媒(电梯广告点位网络)
- **物流网络:** 顺丰控股(直营时效物流/综合供应链)
- **精密制造平台:** 立讯精密(消费电子/AI硬件精密制造)
- **新能源/电池链:** 比亚迪(新能源车/磷酸铁锂/垂直整合)
- **智能汽车:** 华阳集团(智能座舱/HUD) · 德赛西威(座舱/智驾域控)

## How to resume (for Codex)

Follow `docs/000_Ashare_workflow.md` §5.4.6. Per batch: take the next 25 un-triaged companies from the queue by priority order, judge each **independently** under §5.4 + the §5.4.5 anchors and anti-over-inclusion checklist (light triage — business model + durable hard-to-replicate moat + obvious negatives; if the reason is mainly research value, theme exposure, cyclical recovery, scale without pricing power, or self-hedged language such as "需跟踪/可研究", classify as `boundary_pending`), append to the triage CSV, append one batch row to the decision log, and commit with a one-sentence message.
