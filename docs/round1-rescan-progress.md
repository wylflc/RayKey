...
| --- | ---: |
| worth_attention | 251 |
| boundary_pending | 1549 |
| garbage | 20 (governance_fraud 5 / structural_industry 15) |
| **Total triaged** | **1820 / 5653** |

Remaining: `1_worth_attention` **0 — complete** · `2_ex_l5_boundary` **0 — complete (finished inside batch 67)** · `3_unreviewed` **3833**.

Batches done: 3 industry-calibration batches (baijiu 21, panel 8, decoration 15) + batches 01-71 (1775) + 1 ad-hoc single (华天科技). Priority 1 finished inside batch 50; ex-L5 segment (421) finished inside batch 67 — batches 52-67 corrected over-harsh L5 calls on commodity cost-kings, defense materials/devices, and category monopolies under rules 10/12 (陕西煤业·金钼股份·振华股份·芯源微·西部超导·云路股份·华秦科技·联瑞新材·航材股份·江航装备·佳驰科技 etc.). Unreviewed segment underway since batch 67 (000xxx main-board legacy names: mostly regional property/utilities/retail/shell companies — apply rules 9/11, 判例7/13). Cadence 25/batch.

### Current worth_attention pool (251)
...
- **垄断/稀缺资源:** 藏格矿业·盐湖股份(盐湖钾锂) · 锡业股份(全球锡) · 赣锋锂业·天齐锂业·中矿资源(全球锂资源/锂盐/小金属) · 天山铝业(电解铝产能红线/低成本一体化) · 北方稀土(轻稀土配额/最低成本) · 紫金矿业(铜金全球储量/并购整合) · 中国神华(煤炭产能指标/自有铁路一体化) · 中国海油(海上油气专营/桶油低成本) · 宝丰能源(煤制烯烃指标约束/成本曲线最低) · 金石资源(萤石采矿证稀缺/储量第一) · 长江电力(长江梯级水电物理独占/联调超额回报) · 洛阳钼业(铜钴全球储量/低成本) · 中钨高新(钨配额/柿竹园世界级钨矿一体化) · 亚钾国际(老挝钾矿稀缺/低成本爬坡) · 陕西煤业(成本曲线最低端/指标稀缺) · 金钼股份(世界级钼矿全球前三) · 厦门钨业(钨一体化/光伏细钨丝垄断) · 广东宏大(民爆产能许可红线/矿服整合)
