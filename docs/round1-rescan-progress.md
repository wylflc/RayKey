...
### Current worth_attention pool (96)

- **品牌消费:** 贵州茅台·五粮液·山西汾酒·泸州老窖·洋河股份(白酒) · 东阿阿胶·云南白药·华润三九(中药/OTC) · 美的集团·格力电器·苏泊尔(家电/炊具) · 双汇发展(肉制品)
- **垄断/稀缺资源:** 藏格矿业·盐湖股份(盐湖钾锂) · 锡业股份(全球锡) · 赣锋锂业·天齐锂业·中矿资源(全球锂资源/锂盐/小金属) · 天山铝业(铝资源/一体化成本) · 安宁股份(钒钛资源)
- **军工高壁垒电子:** 振华科技·航天电器·中航光电(器件/连接器) · 紫光国微(军工FPGA) · 海格通信(军工通信/北斗) · 光启技术(超材料/尖端装备)
- **AI/半导体/高端电子:** 沃尔核材(高速铜连接) · 顺络电子(高端电感) · 通富微电(先进封装) · 福晶科技(光学晶体) · 光迅科技(光器件/光芯片) · 科大讯飞(AI语音/政教AI) · 北方华创(半导体设备) · 东山精密(AI PCB/FPC/光模块制造) · 沪电股份·深南电路·鹏鼎控股(AI高速PCB/封装基板) · 雅克科技(半导体材料/前驱体) · 中瓷电子(电子陶瓷/高端封装材料) · 华亚智能(半导体设备精密结构件) · 江海股份(高端电容器) · 高德红外(红外/特种光电)
- **软件/硬件生态:** 大华股份·海康威视(安防AIoT) · 石基信息(酒店信息系统) · 广联达(建筑信息化软件) · 奔图科技(国产打印生态)
- **科技/装备龙头:** 中兴通讯·紫光股份(新华三) · 大族激光 · 三花智控(全球热管理) · 汉钟精机(压缩机/真空泵) · 华明装备(分接开关) · 水晶光电(精密光学) · 科华数据·科士达(AIDC电源/UPS) · 英维克(AIDC液冷/温控) · 伊戈尔(磁性器件/SST) · 奥普光电(军工光电) · 杭氧股份(空分设备/工业气体) · 江苏神通(核电/特种阀门) · 双环传动(精密齿轮/传动) · 埃斯顿·雷赛智能(工业机器人/运动控制) · 兆威机电(微型传动) · 豪迈科技(轮胎模具/大型零部件) · 美亚光电(光电识别/口腔CBCT) · 博实股份(工业/特种机器人)
- **资本周期龙头(规则6):** 京东方A·TCL科技(面板) · 中联重科·徐工机械·潍柴动力·中国重汽(机械/重卡)
- **金融:** 宁波银行
- **医药/生物:** 长春高新(金赛) · 华兰生物(浆站) · 上海莱士(血液制品) · 恩华药业(CNS/麻醉精神药) · 科伦药业(输液/ADC创新药) · 康弘药业(眼科/基因治疗) · 东诚药业(核药) · 凯莱英(CDMO) · 鱼跃医疗(家用医疗器械) · 隆平高科(种业/转基因)
- **农牧服务:** 海大集团(饲料/养殖服务平台)
- **化工寡头:** 新和成(维生素)
- **平台网络:** 分众传媒(电梯广告点位网络)
- **物流网络:** 顺丰控股(直营时效物流/综合供应链)
- **精密制造平台:** 立讯精密(消费电子/AI硬件精密制造)
- **新能源/电池链:** 比亚迪(新能源车/磷酸铁锂/垂直整合) · 恩捷股份(锂电隔膜) · 科达利(电池结构件)
