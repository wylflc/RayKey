...
| --- | ---: |
| worth_attention | 96 |
| boundary_pending | 282 |
| garbage | 16 (governance_fraud 2 / structural_industry 14) |
| **Total triaged** | **394 / 5653** |

Remaining: `1_worth_attention` (prior worth_attention) **883** · `2_ex_l5_boundary` **421** · `3_unreviewed` **3955**.

Batches done: 3 industry-calibration batches (baijiu 21, panel 8, decoration 15) + 14 priority-1 batches (350). Cadence 25/batch.
...
- **AI/半导体/高端电子:** 沃尔核材(高速铜连接) · 顺络电子(高端电感) · 通富微电(先进封装) · 福晶科技(光学晶体) · 光迅科技(光器件/光芯片) · 北方华创(半导体设备) · 东山精密(AI PCB/FPC/光模块制造) · 沪电股份·深南电路·鹏鼎控股(AI高速PCB/封装基板) · 雅克科技(半导体材料/前驱体) · 鼎龙股份(CMP/半导体材料) · 中瓷电子(电子陶瓷/高端封装材料) · 江海股份(高端电容器) · 高德红外(红外/特种光电) · 利亚德·洲明科技(全球LED显示平台)
