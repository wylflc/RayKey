...
| --- | ---: |
| worth_attention | 90 |
| boundary_pending | 263 |
| garbage | 16 (governance_fraud 2 / structural_industry 14) |
| **Total triaged** | **369 / 5653** |

Remaining: `1_worth_attention` (prior worth_attention) **908** · `2_ex_l5_boundary` **421** · `3_unreviewed` **3955**.

Batches done: 3 industry-calibration batches (baijiu 21, panel 8, decoration 15) + 13 priority-1 batches (325). Cadence 25/batch.

### Current worth_attention pool (90)
...
- **AI/半导体/高端电子:** 沃尔核材(高速铜连接) · 顺络电子(高端电感) · 通富微电(先进封装) · 福晶科技(光学晶体) · 光迅科技(光器件/光芯片) · 北方华创(半导体设备) · 东山精密(AI PCB/FPC/光模块制造) · 沪电股份·深南电路·鹏鼎控股(AI高速PCB/封装基板) · 雅克科技(半导体材料/前驱体) · 鼎龙股份(CMP/半导体材料) · 中瓷电子(电子陶瓷/高端封装材料) · 江海股份(高端电容器) · 高德红外(红外/特种光电)
- **软件/硬件生态:** 大华股份·海康威视(安防AIoT) · 石基信息(酒店信息系统) · 广联达(造价软件/工程数字化) · 奔图科技(国产打印生态)
- **科技/装备龙头:** 中兴通讯·紫光股份(新华三) · 大族激光 · 汇川技术(工业自动化/工控) · 三花智控(全球热管理) · 汉钟精机(压缩机/真空泵) · 华明装备(分接开关) · 水晶光电(精密光学) · 英维克(AIDC液冷/温控) · 奥普光电(军工光电) · 杭氧股份(空分设备/工业气体) · 江苏神通(核电/特种阀门) · 豪迈科技(轮胎模具/大型零部件) · 美亚光电(色选机品类垄断)
- **资本周期龙头(规则6):** 京东方A·TCL科技(面板) · 中联重科·徐工机械·潍柴动力·中国重汽(机械/重卡)
- **金融/金融科技:** 宁波银行 · 同花顺(金融数据/交易工作流) · 东方财富(互联网券商/财富平台)
- **医药/生物/医疗服务:** 长春高新(金赛) · 华兰生物(浆站) · 上海莱士(血液制品) · 恩华药业(CNS/麻醉精神药) · 科伦药业(输液/ADC创新药) · 东诚药业(核药) · 凯莱英(CDMO) · 鱼跃医疗(家用医疗器械) · 爱尔眼科(眼科连锁) · 隆平高科(种业/转基因)
- **农牧服务:** 海大集团(饲料/养殖服务平台)
- **化工寡头:** 新和成(维生素)
- **平台网络:** 分众传媒(电梯广告点位网络)
- **物流网络:** 顺丰控股(直营时效物流/综合供应链)
- **精密制造平台:** 立讯精密(消费电子/AI硬件精密制造)
- **新能源/电池链:** 比亚迪(新能源车/磷酸铁锂/垂直整合) · 亿纬锂能(二线电池平台/储能圆柱) · 新宙邦(电池特种化学品) · 当升科技(高端正极/固态材料)
- **专业服务:** 华测检测(检测认证)
