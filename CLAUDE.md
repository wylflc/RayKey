...
- **`000_` filename prefix is reserved for files the user opens and reads directly** — it exists to keep those files sorted to the top. Do not add it to documents used only by agents/programs, such as design notes, audits, changelogs, or issue registers. Currently prefixed (all in `docs/`): `000_Ashare_workflow.md`, `000_personal-investment-system-v1.zh.md`, `000_a_share_core_valuation_pool.md`, `000_daily_scan_log.md`, `000_Ashare_workflow_open_issues.md`.
