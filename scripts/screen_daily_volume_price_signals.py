...
按工作流程读取行情、名单、复核状态与两侧模型带，先卖后买生成执行清单，
维护买卖分侧的比例冷却计数器。池外持仓另取行情并纳入卖出侧。
"""
...
SEC93_BUY_LINE = 1.0562        # §9.3.1 买入线（对齐解、保留四位小数；在册合格面 17.772%，v4.199 OI-201 非经营金融资产口径上原线合格面 17.387% 超出 §12.1 容差 0.2pp 而重解，回测日志 §12.258）
