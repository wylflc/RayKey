...
SEC97_BUY_LINE = 0.9963        # §9.7.1，v4.00：ROIC 估值下按 §12.30 对齐解，不得取整
SEC97_MAX_CORR = 0.85          # §9.7.1，252 日日收益率皮尔逊相关上限
SEC97_SCAN_DEPTH = 40          # §9.7.2 第 3 步：相关性过滤时最多下扫多少名
SEC97_TRANCHE_PCT = 0.015      # §9.7.1「单次买入 = 当日净资产 × 1.5%」，v4.00 由 1.0% 改
SEC97_LOT = 100                # A 股一手
SEC97_POSITION_CAP = 0.20      # §9.7.1「单票上限」，v4.00 由 15% 改；**只挡加仓、不强制减持**
SEC97_SELL_LINE = 2.8091       # §9.7.1「减持线」，v4.00 恢复：P/V ≥ 线且收盘 < MA20 → 减一档。
